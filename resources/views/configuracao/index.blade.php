                                    ...
                                    @foreach ($configuracoes as $configuracao)
                                        <tr>
                                            ...
                                            <td class="text-center d-flex">
                                                <a class="text-white mr-1" href="{{ route('configuracao.edit', $configuracao->id) }}"><button class="btn btn-primary"><i
                                                        class="fa fa-edit"></i> </button></a>
                                                <a href="#"
                                                    onclick="$('#form_exclusao').attr('action', '{{ route('configuracao.destroy', $configuracao->id) }}')"
                                                    data-toggle="modal" data-target="#modalConfirmDestroy"><button class="btn btn-danger"><i
